...
#workaroud vpp init issue
cd ${HOME}
git clone https://github.com/openstack/networking-vpp
cd networking-vpp; patch -p1 < /vagrant/init_vpp_agent.diff
git add .
git commit -m "init vpp agent"
