...
function configure_networking_vpp {
    ...
    if [ ! -z "$JWT_CA_CERT" ] ; then
       iniset /$Q_PLUGIN_CONF_FILE ml2_vpp JWT_enable  True
       iniset /$Q_PLUGIN_CONF_FILE ml2_vpp JWT_controller_path_pattern $JWT_CONTROLLER_PATH_PATTERN
       iniset /$Q_PLUGIN_CONF_FILE ml2_vpp JWT_computeNode_path_pattern $JWT_COMPUTENODE_PATH_PATTERN
       iniset /$Q_PLUGIN_CONF_FILE ml2_vpp JWT_controller_name $JWT_CONTROLLER_NAME
       ...
       iniset /$Q_PLUGIN_CONF_FILE ml2_vpp JWT_enable  False
    fi
}
