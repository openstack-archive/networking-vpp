...
ETCD_WRITE_TIME = cfg.CONF.ml2_vpp.etcd_write_time
DB_LOCKWAIT_TIMEOUT = cfg.CONF.ml2_vpp.db_query_time  # default to 60
    ...
    def _forward_worker(self):
        ...
        while True:
            ...
            try:
                ...
                while True:
                    etcd_election.extend_election(DB_LOCKWAIT_TIMEOUT)
