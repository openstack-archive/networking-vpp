...
class JWTUtils(object):
    ...
    def _check_node_name(self, nodeName, vcert_obj):
        ...
        Verify the common name of the signer certificate matches the expected
        node name of the signer.
        ...
        :return : True if the signer common name macthes the nodeName
        """
