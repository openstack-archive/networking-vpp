...
#        return t.sw_if_index
    ...
    def set_snap_static_mapping(self, local_ip, external_ip, is_add=1):
    ...
    def set_snap_address_range(self, first_ip_address, last_ip_address,
                               is_add=1):
        first_ip_address = str(ipaddress.IPv4Address(first_ip_address).packed)
        last_ip_address = str(ipaddress.IPv4Address(last_ip_address).packed)
        self.call_vpp('snat_add_address_range',
