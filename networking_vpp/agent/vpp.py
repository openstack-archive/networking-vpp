...
class VPPInterface(object):
    ...
    def create_vlan_subif(self, if_id, vlan_tag, iface_tag):
        ...
        self._check_retval(t)
        # TODO(cfontaine): Move the tag assignation to create_vlan_subif
        # when it will be supported ( https://jira.fd.io/browse/VPP-587 )
        self.set_interface_tag(t.sw_if_index, iface_tag)
