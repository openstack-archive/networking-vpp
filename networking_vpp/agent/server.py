...
def main():
    ...
    agent_features = [ext.obj for ext in extension.ExtensionManager(
            namespace='networking_vpp.agent.features',
            invoke_on_load=True,
            invoke_args=(cfg.CONF.host, etcd_client, vppf)).extensions]
