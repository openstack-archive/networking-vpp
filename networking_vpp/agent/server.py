...
class VPPForwarder(object):
    ...
    def create_router_on_host(self, router):
        ...
        if not found:
            # Add this IP address tp this BVI interface
    ...
    def associate_floatingip(self, floatingip_dict):
        ...
        self.vpp.set_snap_static_mapping(
...
class EtcdListener(object):
    def __init__(self, host, etcd_client, vppf, physnets):
        ...
        self.etcd_helper.ensure_dir(LEADIN +
                                    '/nodes/%s/ROUTER_INTF_DIR' % self.host)
        self.etcd_helper.ensure_dir(LEADIN +
                                    '/nodes/%s/ROUTER_FIP_DIR' % self.host)
