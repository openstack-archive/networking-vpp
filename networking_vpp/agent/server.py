...
class VPPForwarder(object):
    ...
    def _to_acl_rule(self, r, d, a=2):
        ...
        if not reflexive_acls:
            a = 1
        elif reflexive_acls and r.protocol in [6, 17]:  # enable reflexive
            a = 2
        else:
            a = 1  # No reflexive for all other traffic
    ...
    def get_spoof_filter_rules(self):
        ...
        def _compose_rule(is_permit,
                          ...
                          dstport_or_icmpcode_first,
                          dstport_or_icmpcode_last):
            # Set is_permit = 2  if reflexive_acls and traffic is permitted
            if is_permit == 1 and reflexive_acls:
                is_permit = 2
            return {
                'is_permit': is_permit,
                'is_ipv6': is_ipv6,
