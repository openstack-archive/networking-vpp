    ...
    def fix_uplinks(self, physnets):
        ...
        for f in self.vpp.get_interfaces():
            ...
            if physnet_name is not None:
                physnet_ports_found[physnet_name] = f['sw_if_index']
        ...
        for uplink_physnet, net_type, seg_id, sw_if_index, sup_sw_if_idx \
            ...
            if (uplink_physnet not in configured_physnet_interfaces
                    or sup_sw_if_idx != configured_physnet_interfaces[name]):
        ...
        for name, if_index in physnet_ports_found:
            if configured_physnet_interfaces[name] != if_index:
...
class EtcdListener(object):
    ...
    def vpp_restart_prepare(self):
        ...
        self.vppf.fix_uplinks(self.physnets)
