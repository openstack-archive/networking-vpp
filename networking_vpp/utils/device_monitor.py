        ...
        while True:
            ...
            if ready:
                try:
                    ...
                    # and is available but deprecated in more modern versions 
                    # We favour this so that we test this codepath either way;
                    # that gets us a better well worn path
                    action, device = monitor.receive_device()
                except AttributeError:
                    # This will work with pyudev >= v0.16
                    # It used to be the default, and is known to work well
